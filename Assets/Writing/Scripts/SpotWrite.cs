...
public class SpotWrite : MonoBehaviour
{
	public GameObject LetterPrefab;
	public string sentence;
	public GameObject protagonist;
	public Camera camera;
	public float textHorizontalStartPosition;
	...
	void Start()
	{
		letterPosition = textHorizontalStartPosition;
		MakeSentence();
	}

	void Update(){
		if(characterIsPastStartingPosition()){
	...
	private bool characterIsPastStartingPosition(){
		return protagonist.transform.position.x > startPosition;
	}
	...
	GameObject makeLetter(char c)
	{
		...
		a.SendMessage("setEnd", endPosition);
